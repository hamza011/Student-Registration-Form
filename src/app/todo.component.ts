...
@Component({
    ...
    template : `
     <div class="parent">
        <form class='registrationForm'>
            ...
            <input type="email" #email placeholder="Email Address" name= "email" id="mailAddress"/>
            <input type="text" #age placeholder="age" name= "age" id="age"/>
    ...
    styles : [`
        ...
        button.submitButton:hover{ transform : scale(1.05); transition : 0.3s; color : #C3002F; background : #fff; border : 1px solid #C3002F; }
